...
```{r plot-add-legend, fig.width=4, fig.height=4, fig.cap="Figure 8: Plot of exchangeable Al vs. pH by sample location, with custom graphics parameters and axis titles, and a legend to explain the plot symbols.", message=FALSE, warning=FALSE, results='hold'}
par(mar=c(4,4,1,1), mgp=c(2,0.6,0), font.lab=2)
with(hubbard,
       plot(EXCH_Al ~ PH, xlab="Soil pH", 
            ylab="Exchangeable Al (centimoles/kg)",
...
```{r gg-AlEx-pH-2, fig.cap="Figure 9: Plot of exchangeable Al vs. pH in the Hubbard Brook soil data using the `ggplot2` R package showing points categorized by the factor `Rel.To.Brook`, and using a non-default plot theme.", fig.height=3.5, fig.width=4.8, message=FALSE, warning=FALSE}
library(ggplot2)
ggplot(data=hubbard, 
...
(`Rel.To.Brook`). A legend is created automatically. We have also used a
...
```{r car-sp-2, fig.width=3.5, fig.height=3.5, fig.cap="Figure 11: Plot of exchangeable Al vs. pH with points grouped by location, made using the car::scatterplot() function.", message=FALSE, warning=FALSE, results='hold'}
