...
These data are from the [Hubbard Brook Experimental Forest](https://hubbardbrook.org/experimental-watersheds-research-sites/){target="_blank"}
near Woodstock in New Hampshire, USA (Figure 1). Geological map units used to
generate the factor `Rocktype` are from 
