...
legend(s3d$xyz.convert(1.8, 0.75, 1), legend = levels(eDNA2022$Site), title="Site", 
...
```{r stress-plot, fig.height=5, fig.width=7, fig.align='center', out.width="60%", fig.cap="Figure 5: Stress plot showing the goodness-of-fit between actual dsiimilarity for the Ashfield Flats 2022 eDNA data and dissimilarities predicted by NMDS ordination distances.", message=FALSE, warning=FALSE}
...
AF_nmds_aquat
```
```{r plot nmds aquat Bray, fig.height=4, fig.width=4, fig.align='center', fig.cap="Figure 6: Basic NMDS plot showing observations as symbols and species as text. Presence-absence data from eDNA sampling and analysis at Ashfield Flats."}
par(mfrow=c(1,1), mar=c(3,3,2,0.5), mgp=c(1.5,0.2,0), tcl=0.2, font.lab=2)
...
```{r alt-to-vegan-nmds-aquat, fig.height=3.5, fig.width=5, fig.cap="Figure 7: Two-dimensional non-metric multidimensional scaling (NMDS) plot showing observations as symbols and species as text located in MDS2 vs. MDS1 space. Presence-absence data for aquatic species only from eDNA sampling and analysis at Ashfield Flats.", echo=1:5}
palette(c("black", plasma(10))) # a viridis palette
...
```{r decorana-plot, fig.height=4, fig.width=4, fig.cap="Figure 8: Two-dimensional detrended correspondence analysis (DCA) plot showing observations as symbols and species as text. Presence-absence data from water sampling and eDNA analysis at Ashfield Flats."}
par(mfrow=c(1,1), mar=c(3,3,0.5,0.5), mgp=c(1.5,0.2,0), tcl=0.2, font.lab=2)
