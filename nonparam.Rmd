...
3. Calculate a C*ohen's d effect size for a 2-group mean comparison*
...
<a href="https://echo360.net.au/media/b92bf5fa-bbbb-42dd-9567-697591b2e6c9/public" target="_blank" rel="noopener">🎬&nbsp;Video - **Means Comparisons 2 &ndash; Pairwise comparisons**</a>.

<a href="https://echo360.net.au/media/2eb6c92b-8b13-4c0c-a575-1de857a31166/public" target="_blank" rel="noopener">🎬&nbsp;Video - **Means Comparisons 3 &ndash; Non-parametric tests**</a>.

<a href="https://echo360.net.au/media/3a49397c-92c6-47a9-86e7-2c840fd19d81/public" target="_blank" rel="noopener">🎬&nbsp;Video - **Means Comparisons 4 &ndash; How to make a Factor from a Variable**</a>.

### Supporting Information

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243037_1/xid-40243037_1" target="_blank" rel="noopener">📰**Decision tree for means comparisons methods**</a><br />(as used in ENVT3361)

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243821_1/xid-40243821_1" target="_blank" rel="noopener">**📰&nbsp;Means comparisons: Null hypothesis testing and Effect size**</a><br />(PDF of slides from 2017, still ~OK) **NB** based on using R Commander*<span style="font-size: 9pt;"><sup>&para;</sup>, but the code shown on screen should still work!<br />
<span style="font-size: 10pt;"><sup>&para;</sup> a package which allows some point-and-click operation of R

### Code and Data files

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243070_1/xid-40243070_1" target="_blank" rel="noopener">🔣 R code file for **Workshop: Advanced Means Comparisons**</a> &ndash; for Week 6, start at**<span style="font-size:9pt; font-family: 'courier new', courier, monospace;"> Non-parametric tests (line 409)**

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243016_1/xid-40243016_1" target="_blank" rel="noreferrer noopener">🔣 R code for means&nbsp;on boxplots</a> &nbsp; &nbsp; <a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243019_1/xid-40243019_1" target="_blank" rel="noreferrer noopener">🔣 R code for means and confidence intervals&nbsp;on boxplots</a>&nbsp; (more complex)

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243084_1/xid-40243084_1" target="_blank" rel="noreferrer noopener">🔣 R code for calculating&nbsp;pairwise Cohen's d effect sizes</a>&nbsp; (advanced)

<a href="https://lms.uwa.edu.au/bbcswebdav/pid-3091994-dt-content-rid-40243097_1/xid-40243097_1">📊Smith's Lake / Veryard Reserve data (sv2017) in CSV format</a>
</div>
...
sv2017 <- read.csv("../Learn-R/sv2017_original.csv", stringsAsFactors = TRUE)
...
on ranking of observations, so should be independent of transformation &ndash; as in 
the example below:
...
```{r Na-as-ranks, fig.height=2, fig.width=10, message=FALSE, warning=FALSE, out.width="75%", fig.cap="Figure 1: Na concentration ranks in soil in each reserve area, sampled at Smith's Lake and Charles Veryard Reserves in 2017.", echo=FALSE}
par(mar=c(3,6,1,1), mgp=c(1.3,0.2,0),tcl=0.2,font.lab=2,las=1)
with(sv17_soil[which(sv17_soil$Reserve=="Smiths"),],
     plot(which(sv17_soil$Reserve=="Smiths"),
          rep(1.02, length(which(sv17_soil$Reserve=="Smiths"))), 
          xlim=c(2,76), ylim=c(0.95,1.15), cex.lab=1.4,
          pch="|", col="#008080", cex=3, xlab="Na rank", ylab="", yaxt="n"))
with(sv17_soil[which(sv17_soil$Reserve=="Veryard"),],
     points(which(sv17_soil$Reserve=="Veryard"),
            rep(1.08, length(which(sv17_soil$Reserve=="Veryard"))), ylim=c(0.8,1.4),
            pch="|", col="sienna", cex=3))
axis(2, at=1.02, labels=levels(sv17_soil$Reserve)[1], 
     col.axis="cyan4", las=1, cex.axis=1.4)
axis(2, at=1.08, labels=levels(sv17_soil$Reserve)[2], 
...
```{r Fe-as-ranks, fig.height=2, fig.width=10, message=FALSE, warning=FALSE, out.width="75%", fig.cap="Figure 2: Fe concentration ranks in sediment, soil, and street dust sampled at Smith's Lake and Charles Veryard Reserves in 2017.", echo=FALSE}
par(mar=c(3,6,1,1), mgp=c(1.3,0.2,0),tcl=0.2,font.lab=2,las=1)
with(sv2017[which(sv2017$Type=="Sediment"),],
     plot(which(sv2017$Type=="Sediment"),
          rep(1, length(which(sv2017$Type=="Sediment"))), 
          xlim=c(2,96), ylim=c(0.95,1.15), cex.lab=1.4,
          pch="|", col="#008080", cex=3, xlab="Fe rank", ylab="", yaxt="n"))
with(sv2017[which(sv2017$Type=="Soil"),],
     points(which(sv2017$Type=="Soil"),
            rep(1.05, length(which(sv2017$Type=="Soil"))), ylim=c(0.8,1.4),
            pch="|", col="sienna", cex=3))
with(sv2017[which(sv2017$Type=="Street dust"),],
     points(which(sv2017$Type=="Street dust"),
        rep(1.1, length(which(sv2017$Type=="Street dust"))), ylim=c(0.8,1.4),
            pch="|", col="gray10", cex=3))
axis(2, at=1, labels=levels(sv2017$Type)[1], 
     col.axis="cyan4", las=1, cex.axis=1.4)
axis(2, at=1.05, labels=levels(sv2017$Type)[2], 
     col.axis="sienna", las=1, cex.axis=1.4)
axis(2, at=1.1, labels=levels(sv2017$Type)[3], 
