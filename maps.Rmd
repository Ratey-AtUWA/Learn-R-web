...
## Alternative 2 &ndash; Maps in R using the ggmap package
...
This always gives a **square** map (Figure 10) &ndash; which we might not always
...
```{r ggmap1, fig.height=4.5, fig.width=6, fig.align='center', fig.cap="Figure 10: Map of the University of Western Australia campus at Crawley, showing the location of libraries and cafés, plotted over Google maps tiles acquired using the `R` package `ggmap`.", out.width='75%', message=FALSE, warning=FALSE, results='hold'}
ggmap(udubua.gg) + 
...
[**The next example**]{style="size: 14pt"} (Figure 11) uses the simple features
