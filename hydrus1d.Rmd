...
<div style="border: 2px solid #039; background-color:#f0f0f0; padding: 8px;">
...
output files in Excel, or figure out a way of using more flexible
software. 

## Reading data copied from a Hydrus-1D plot

This is an easier alternative to reading the data stored in the 
...
### Plot the data (symbols and lines)
