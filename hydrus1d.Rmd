...
```{r conc-depth, fig.width=4, fig.height=6, fig.cap="Figure 4: Plot of simulated solute concentration vs. vertical depth for each simulation time step, using Hydrus-1D", results='hold'}
...
```{r conc-hdist, fig.width=6, fig.height=4, fig.cap="Figure 5: Plot of simulated solute concentration vs. horizontal distance for each simulation time step, using Hydrus-1D", results='hold'}
