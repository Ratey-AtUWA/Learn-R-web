---
title: "RStudio graphics and plotting with ggplot"
date: "`r Sys.Date()`"
output: 
  html_document:
    highlight: kate
...
[base-R graphics page](plots.html) if you're not 
...
```{r Zn-Fe-gg-by-groups, fig.height=3, fig.width=4.5, fig.cap="Figure 10: Plot of Ca *vs*. pH using `ggplot2`, showing how to separate points into different groups based on factor levels.", message=FALSE, warning=FALSE}
...
```{r Zn-Fe-gg-groups-recol, fig.height=3, fig.width=4.5, fig.cap="Figure 11: Plot of Ca *vs*. pH using `ggplot2`, showing how to separate points into different groups based on factor levels.", message=FALSE, warning=FALSE}
ggplot(data=sv18, mapping=aes(x=Fe, y=Zn, colour=Type, shape=Type)) +
  geom_point(size=2) + 
...
```{r gg-depth-profile, fig.height=5, fig.width=3.6, fig.cap="Figure 17: Plots of Fe vs. depth measurements in the sv18 data."}
...
library(ggmap)
register_google(key=read.csv("../Learn-R/gmapskey.csv")[1,1])
