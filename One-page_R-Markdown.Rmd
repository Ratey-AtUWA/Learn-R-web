...
For a thinner line, use a lower pixel value, *e.g*. `height: 2px`. The line 
colour set by `background-color:` can be any valid html colour name, or a 3- or 
6-character hexadecimal colour code (*e.g*. `background-color: #039;`).

&nbsp;

💡 We deal with [**R Markdown code chunk options** in another page on this site](chunk-options.html){target="_blank"}.
