...
```{r plot-add-legend, fig.width=4, fig.height=4, fig.cap="Figure 7: Plot of exchangeable Al vs. pH by broad rock type, with custom graphics parameters and axis titles, and a legend to explain the plot symbols.", message=FALSE, warning=FALSE, results='hold'}
par(mar=c(4,4,1,1), mgp=c(2,0.6,0), font.lab=2)
with(hubbard,
       plot(EXCH_Al ~ PH, xlab="Soil pH", 
            ylab="Exchangeable Al (centimoles/kg)",
...
# An alternative to base-R plot: `scatterplot()` (from the `car` package) 
...
```{r car-sp-2, fig.width=4, fig.height=4, fig.cap="Figure 9: Plot of exchangeable Al vs. pH with points grouped by rock type, made using the car::scatterplot() function.", message=FALSE, warning=FALSE, results='hold'}
