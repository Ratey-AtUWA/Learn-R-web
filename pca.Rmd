...
```{r biplots-PCA-AF-newdims, fig.height=12, fig.width=8, fig.align='center', fig.cap="Figure 7: PCA biplots for Ashfield data, with observations categorised by sample type for: (a) PC3 vs. PC1; (b) PC4 vs. PC1; (c) PC3 vs. PC2; (d) PC4 vs. PC2; (e) PC4 vs. PC3.", results='hold'}
data0 <- na.omit(ashfield_clr[,c(3,4,11:38)])
...
Alternatively we could look at a 3D plot (Figure 8) susing the `scatterplot3d` package.

```{r pca-obs-3D, fig.cap="Figure 8: Plot of (a) observation scores and (b) component (variable) loadings for PCA on clr-transformed sediment elemental concentrations from Ashfield Flats 2019-2021.", fig.height=5, fig.width=12}
