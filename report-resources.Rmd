...
<div style="border: 2px solid #039; background-color:#e8e8e8; padding: 4px;">
**On this site**: [Tables & trigger value counts](tablesPlus.html) | [Locality and Site Plan maps](maps-location-siteplan.html) | [Brief essentials of R markdown](One-page_R-Markdown.html)
</div>
...
(`flextable` is the package we will use, but there are multiple other options)
